...
const MediaContent = ({ params }) => {
      ...
      <div className="w-full h-80 flex flex-col gap-2 items-center justify-center">
        ...
        >
          ...
          <span className="text-lg font-semibold font-montserrat">
            ...
            {getTranslation("common_backTo")} Press Release
          </span>
        </Link>
      </div>
    );
  ...
  return (
    <div className="flex gap-10 mx-auto max-w-[1500px] px-10 py-20 min-[1000px]:flex-col">
      <div className="flex flex-col max-[1000px]:w-2/3">
        {postImageUrl && (
          <Image
            src={postImageUrl}
            alt={post.title}
      ...
      <div className="flex flex-col max-[1000px]:w-1/3">
        <Link
          href="/media/press"
          className="flex items-center gap-5 mb-5 text-primary"
        >
